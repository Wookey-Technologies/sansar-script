...
namespace ScriptLibrary
{
    ...
    public class Sound : SceneObjectBase // Playing sounds at scene positions requires ScenePrivate. Could make another version that always played on the object component of rezzed objects.
    {
