...
public class MediaPlayerControllerWall : SceneObjectScript

{
    ...
    private string ControlSurface1 = "SendPlayShuffle,-111.25,-2.5,-97.75,-2.5,-97.75,2.5,-111.25,2.5,12.15,25.65";
    private string ControlSurface2 = "SendPlayList,-97.45,-2.5,-83.95,-2.5,-83.95,2.5,-97.45,2.5,12.15,25.65";
    private string ControlSurface3 = "SendStop,-72.75,-2.5,-59.25,-2.5,-59.25,2.5,-72.75,2.5,12.15,25.65";
    private string ControlSurface4 = "SendPrevious,-58.85,-2.5,-45.35,-2.5,-45.35,2.5,-58.85,2.5,12.15,25.65";
    private string ControlSurface5 = "SendPause,-44.65,-2.5,-31.15,-2.5,-31.15,2.5,-44.65,2.5,12.15,25.65";
    private string ControlSurface6 = "SendResume,-30.85,-2.5,-17.35,-2.5,-17.35,2.5,-30.85,2.5,12.15,25.65";
    private string ControlSurface7 = "SendNext,-16.75,-2.5,-3.25,-2.5,-3.25,2.5,-16.75,2.5,12.15,25.65";
    private string ControlSurface8 = "SendNext,-16.75,-2.5,-3.25,-2.5,-3.25,2.5,-16.75,2.5,12.15,25.65";
    private string ControlSurface9 = "SendVolumeDown,45.85,-2.5,59.35,-2.5,59.35,2.5,45.85,2.5,12.15,25.65";
    private string ControlSurface10 = "SendVolumeUp,53.55,-2.5,67.05,-2.5,67.05,2.5,53.55,2.5,12.15,25.65";
    private string ControlSurface11 = "SendEject,98.25,-2.5,111.75,-2.5,111.75,2.5,98.25,2.5,12.15,25.65";
    private string ControlSurface12 = "play1,-110.75,-2.5,-97.25,-2.5,-97.25,2.5,-110.75,2.5,33.85,47.35";
    private string ControlSurface13 = "play2,-96.95,-2.5,-83.45,-2.5,-83.45,2.5,-96.95,2.5,33.85,47.35";
    private string ControlSurface14 = "play3,-82.95,-2.5,-69.45,-2.5,-69.45,2.5,-82.95,2.5,33.85,47.35";
    private string ControlSurface15 = "play4,-68.75,-2.5,-55.25,-2.5,-55.25,2.5,-68.75,2.5,33.85,47.35";
    private string ControlSurface16 = "play5,-54.95,-2.5,-41.45,-2.5,-41.45,2.5,-54.95,2.5,33.85,47.35";
    private string ControlSurface17 = "play6,-34.35,-2.5,-20.85,-2.5,-20.85,2.5,-34.35,2.5,33.85,47.35";
    private string ControlSurface18 = "play7,-20.45,-2.5,-6.95,-2.5,-6.95,2.5,-20.45,2.5,33.85,47.35";
    private string ControlSurface19 = "play8,-6.25,-2.5,7.25,-2.5,7.25,2.5,-6.25,2.5,33.85,47.35";
    private string ControlSurface20 = "play9,7.65,-2.5,21.15,-2.5,21.15,2.5,7.65,2.5,33.85,47.35";
    private string ControlSurface21 = "play10,21.45,-2.5,34.95,-2.5,34.95,2.5,21.45,2.5,33.85,47.35";
    private string ControlSurface22 = "play11,42.15,-2.5,55.65,-2.5,55.65,2.5,42.15,2.5,33.85,47.35";
    private string ControlSurface23 = "play12,56.15,-2.5,69.65,-2.5,69.65,2.5,56.15,2.5,33.85,47.35";
    private string ControlSurface24 = "play13,70.05,-2.5,83.55,-2.5,83.55,2.5,70.05,2.5,33.85,47.35";
    private string ControlSurface25 = "play14,84.05,-2.5,97.55,-2.5,97.55,2.5,84.05,2.5,33.85,47.35";
    private string ControlSurface26 = "play15,97.95,-2.5,111.45,-2.5,111.45,2.5,97.95,2.5,33.85,47.35";
