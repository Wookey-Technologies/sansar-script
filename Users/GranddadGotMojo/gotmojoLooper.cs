...
*/
    ...
    public override void Init()
    {
        ...
        SubscribeToScriptEvent("60Down", changeBPM);
        SubscribeToScriptEvent("80Down", changeBPM);
        SubscribeToScriptEvent("100Down", changeBPM);
        SubscribeToScriptEvent("120Down", changeBPM);
        SubscribeToScriptEvent("140Down", changeBPM);
        SubscribeToScriptEvent("160Down", changeBPM);
        SubscribeToScriptEvent("GlobalDown", changeBPM);
...
/*
    ...
    */
    ...
    private void changSound(ScriptEventData sed)
    {
        //Log.Write("stopTrack: " + sed.Message);
