...
public class SensorVRController : SceneObjectScript

{
    ...
    private void UpdatePosition()
    {
        ...
        //Log.Write("Left: " + agent.GetControlPointPosition(ControlPointType.LeftTool) + " Right: " + agent.GetControlPointPosition(ControlPointType.RightTool));
        ...
        do
        {
            ...
            ActionToPerform(LeftPosition, WorldLeftPosition, RightPosition, WorldRightPosition, AgentPosition, AgentRotation);
    ...
    private void ActionToPerform(Vector LeftPos, Vector WorldLeftPos, Vector RightPos, Vector WorldRightPos, Vector AgentPos, Quaternion AgentRot)
    {
        //put your unique game logic here
        Log.Write("Agent Position: " + AgentPos + " Rotation: " + AgentRot + " Left: " + LeftPos + " Left World: " + WorldLeftPos + " Right: " + RightPos + " Right World: " + WorldRightPos);
    }
