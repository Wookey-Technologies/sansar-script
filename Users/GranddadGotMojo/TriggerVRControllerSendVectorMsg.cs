...
public class TriggerVRControllerSendVectorMsg : SceneObjectScript

{
    ...
    private void LeftActionToPerform(Vector LeftPos, Vector LeftWorldPos, Vector AgentPos, Quaternion AgentRot)
    {
        //put your unique game logic here
        Log.Write("Left Button: " + LeftTriggerPressed + " Position: " + AgentPos + " Rotation: " + AgentRot + " Left: " + LeftPos);
        SendVRControllerInfo(agent, "Left", LeftPos, LeftWorldPos);
    }
    ...
    private void RightActionToPerform(Vector RightPos, Vector RightWorldPos, Vector AgentPos, Quaternion AgentRot)
    {
        //put your unique game logic here
        Log.Write("Right Button: " + RightTriggerPressed + " Position: " + AgentPos + " Rotation: " + AgentRot + " Right: " + RightPos + " World: " + RightWorldPos);
        SendVRControllerInfo(agent, "Right", RightPos, RightWorldPos);
    }
    ...
    public class VRControllerInfo : Reflective
    {
        public AgentPrivate VRAgent { get; set; }
        public string VRController { get; set; }
        public Vector VRControllerLocalPosition { get; set; }
        public Vector VRControllerWorldPosition { get; set; }
    }

    private void SendVRControllerInfo(AgentPrivate agentIn, string controllerUsed, Vector localPos, Vector worldPos)
    {
        VRControllerInfo sendVRControllerInfo = new VRControllerInfo();

        sendVRControllerInfo.VRAgent = agentIn;
        sendVRControllerInfo.VRController = controllerUsed;
        sendVRControllerInfo.VRControllerLocalPosition = localPos;
        sendVRControllerInfo.VRControllerWorldPosition = worldPos;

        //Log.Write("TrackStripNumber: " + volumeStripNumberIn + " volumePosition: " + volumePositionIn);

        PostScriptEvent(ScriptId.AllScripts, "VRControllerInfo", sendVRControllerInfo);
    }

    #region SimpleScripts
